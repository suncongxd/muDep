...
public class ClassUtil {
    ...
    public static void main(String[] args) throws Exception{
        List<Class<?>> cls = getClassesFromPackage("overidedSubclass");
...
//        try {
//            String packageCodePath = MyApplication.getContext().getPackageCodePath();
...
//    }
    ...
    public static List<Class> getAllClassByInterface(Class c) {
        ...
        if(c.isInterface()) {
            ...
            // 获取当前包下以及子包下所以的类
            List<Class<?>> allClass = getClassesFromPackage(packageName);
            if(allClass != null) {
...
//            dirs = pathClassLoader.getResources(packageDirName);
            //循环迭代下去
    ...
    public static Class[] getClasses(String packageName) throws ClassNotFoundException, IOException {
        Context thisContext = MyApplication.getContext();
            ClassLoader classLoader =  thisContext.getClassLoader();
...
//        Log.v("resource", resources.);
        List<File> dirs = new ArrayList();

        while (resources.hasMoreElements()) {

            URL resource = resources.nextElement();
            Log.v("resource", resource.getPath());
